...
include("src/SimulationCode.jl")
   ...
   ## Example Weysser Mixture
    ...
    q_cutoff = 1.4                  # Size of the shell of the calculation of the Steinhardt order parameters
    N_stepsMC = 10^3                # Number of MC steps to take
    N_stepsMD = 2*10^4                # Number of time steps to take
    ...
    skin_distanceMD = 0.35          # Size of the verlet cells for MD
