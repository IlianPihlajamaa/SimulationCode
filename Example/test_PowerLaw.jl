...
include("src/SimulationCode.jl")
   ...
   ## Example Weysser Mixture
    ...
    ρ = 0.94
    force_cutoff = 10.0             # Force cutoff
    interaction_potential = SimulationCode.PowerLaw(1.0, 1.0, 12, force_cutoff)
    ...
    simulation_name = joinpath(@__DIR__, simulation_folder, "IPL$(interaction_potential.n)_$(dims)_ρ_$(ρ)_seed_$(random_seed)")    # Name of the datafile
    ...
    neighborlist = SimulationCode.initialize_neighbor_struct(skin_distanceMC, box_size, force_cutoff, N, arrays.D_array, dims; maxneighbours=500)
    ...
    @time SimulationCode.perform_swap_monte_carlo!(arrays, parameters, output, neighborlist)
